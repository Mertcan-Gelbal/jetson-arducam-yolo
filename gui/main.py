    ...
    def palette(is_dark: bool) -> dict:
        if is_dark:
            return {
                ...
                "txt": "#EAF0FA",
                "sub": "#9BA8C0",
                "brd": "rgba(128, 148, 184, 0.30)",
                "ibg": "#1A2438",
                "hov": "rgba(66, 133, 244, 0.16)",
                "ihov": "#202B40",
                "ov_bg": "rgba(7, 10, 16, 0.88)",
                "card_txt": "#F3F7FE",
                "preview_bg": "#0D1320",
                "preview_br": "rgba(114, 142, 189, 0.42)",
                "surface_row": "#141D2C",
                "surface_row_compact": "#121927",
                "hairline": "#2B3B58",
                "card_header_bg": "#1A263B",
                "meta_panel_bg": "#131D2F",
                "accent_soft_bg": "rgba(66, 133, 244, 0.14)",
                "accent_soft_br": "rgba(117, 173, 255, 0.42)",
                "ctx_menu_bg": "#162138",
                "ctx_menu_hi": "rgba(66, 133, 244, 0.20)",
                "pop_edge": "#3B4E71",
                "zt_inset": "#10192A",
                "focus_shell_top": "#1C2A42",
                "focus_shell_bot": "#111A2B",
                "focus_border_hi": "#7FB0FF",
                "focus_panel": "rgba(255,255,255,0.07)",
                "focus_panel_br": "rgba(127, 176, 255, 0.36)",
                "accent_net": "#34D399",
                "toast_scrim": "rgba(12, 18, 30, 0.95)",
            }
        return {
            "bg": "#EEF3FB",
            "canvas": "#F4F7FC",
            ...
            "txt": "#182338",
            "sub": "#61708B",
            "brd": "rgba(45, 74, 120, 0.18)",
            "ibg": "#F7FAFF",
            "hov": "rgba(66, 133, 244, 0.10)",
            "ihov": "#ECF3FF",
            "ov_bg": "rgba(235, 242, 252, 0.86)",
            "card_txt": "#1F2B42",
            "preview_bg": "#F2F7FF",
            "preview_br": "rgba(80, 116, 180, 0.24)",
            "surface_row": "#F7FAFF",
            "surface_row_compact": "#F1F6FF",
            "hairline": "#D8E2F1",
            "card_header_bg": "#F5F8FF",
            "meta_panel_bg": "#F4F8FF",
            "accent_soft_bg": "rgba(66, 133, 244, 0.10)",
            "accent_soft_br": "rgba(66, 133, 244, 0.28)",
            "ctx_menu_bg": "#FFFFFF",
            "ctx_menu_hi": "rgba(66, 133, 244, 0.12)",
            "pop_edge": "#C9D7EC",
            "zt_inset": "#F8FBFF",
            "focus_shell_top": "#FFFFFF",
            "focus_shell_bot": "#F3F7FF",
            "focus_border_hi": "#4A86F7",
            "focus_panel": "rgba(255,255,255,0.96)",
            "focus_panel_br": "rgba(66, 133, 244, 0.22)",
            "accent_net": "#15803D",
            "toast_scrim": "rgba(255, 255, 255, 0.97)",
        }
